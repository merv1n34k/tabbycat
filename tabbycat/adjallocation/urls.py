...
urlpatterns = [
    path('round/<int:round_seq>/', include([
        ...
        path('debates/edit/concurrent/',
            views.MultiRoundEditDebateAdjudicatorsView.as_view(),
            name='edit-debate-adjudicators-multi'),
        path('panels/edit/',
    ...
    path('conflicts/', include([
        ...
        path('adjudicator-speaker/',
            views.AdjudicatorSpeakerConflictsView.as_view(),
            name='adjallocation-conflicts-adj-speaker'),
    ])),
]
